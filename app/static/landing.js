...
$(document).ready(function () {
    ...
    tower_selector = new Vue({
        ...
        data: {
            ...
            default_message:
                "To create a new tower, enter a name for that tower. To join a tower, enter the Tower ID number.",
            message:
                "To create a new tower, enter a name for that tower. To join a tower, enter the Tower ID number.",
        },
        ...
        methods: {
            ...
            check_tower_id: function () {
                console.log(
                    "checking, length is: " + this.trimmed_input.length
                );
                ...
                if (this.trimmed_input.length == 9) {
                    ...
                    if (tower_id) {
                        ...
                        socketio.emit("c_check_tower_id", {
                            tower_id: tower_id,
                        });
                    } else {
